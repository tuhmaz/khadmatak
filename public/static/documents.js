...
function updateDocumentsUI() {
    ...
    updateDashboardLinksDocuments();
}

// Update dashboard links in documents page based on user type
function updateDashboardLinksDocuments() {
    // Get all dashboard links in documents page
